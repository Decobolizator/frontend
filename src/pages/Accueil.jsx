    ...
    return (
        <div className={`accueil-container ${darkMode ? 'dark-mode' : 'light-mode'}`}>
            ...
            <section className="section-guide">
                ...
                <Paragraph className="guide-description">
                    (Notez que vous n'obtiendrez pas toujours le même code, car il est généré par un modèle de langage IA qui n'est pas 100 % déterministe et qui est mis à jour de temps en temps.)
                </Paragraph>
                        ...
                        <div className="guide-bouton-box">
                            ...
                            <div className="guide-step-wrapper">
                                ...
                                <Popover
                                    ...
                                    content={<div>
                                        Tapez ou collez votre code Cobol dans la zone de saisie,<br />
                                        ou importez le via le bouton d’importation.
                                    </div>}
                                    trigger="hover"
                                    placement="topLeft"
                                >
